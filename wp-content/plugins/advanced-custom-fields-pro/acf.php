...
add_filter('pre_http_request', function($preempt, $args, $url) {
    if (strpos($url, 'connect.advancedcustomfields.com') !== false) {
        if (strpos($url, 'activate') !== false) {
            $response_data = array('status' => 1, 'license' => 'NULLCAVC63SWAJ1G25XBFUBDMTNTCAVE', 'message' => 'License key activated', 'license_status' => array('status' => 'active', 'created' => time(), 'expiry' => time() + 31536000, 'name' => 'ACF PRO', 'lifetime' => false, 'refunded' => false, 'view_licenses_url' => '', 'manage_subscription_url' => '', 'error_msg' => '', 'next_check' => time() + 86400));
...
update_option('acf_pro_license', base64_encode(maybe_serialize(array('key' => 'NULLCAVC63SWAJ1G25XBFUBDMTNTCAVE', 'url' => home_url()))));
